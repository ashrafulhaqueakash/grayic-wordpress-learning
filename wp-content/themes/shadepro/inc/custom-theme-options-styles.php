...
function shadepro_theme_options_style()
{
	...
	//
	wp_enqueue_style('shadepro-theme-options-style', get_template_directory_uri() . '/assets/css/theme_options_style.css');
	$page_id = get_the_ID();
	$css_output = '';
	/*=============================================
...
add_action('wp_enqueue_scripts', 'shadepro_theme_options_style');
