(function ($) {
    ...
    $(window).load(function () {
        if ($.fn.packery) {
            $('.blog-content-row .posts-row').packery({
    ...
    function shadeCartQtyBtn(){
        $(".woocommerce-cart-form .quantity").append('<span class="shade-qty-dec-btn shade-qty-counter">-</span><span class="shade-qty-inc-btn shade-qty-counter">+</span>');
        $(".woocommerce-cart-form .quantity .shade-qty-counter").on("click", function () {
            var $button = $(this);
            ...
            $('.woocommerce-cart-form div.quantity input.qty').change();
        });
    }
    shadeCartQtyBtn();
    ...
    $(document).ajaxComplete(function (event, request, settings) {
        if($('.woocomerce-cart-form .quantity .shade-qty-counter')){
            console.log('hellow')
            $(".woocommerce-cart-form .quantity .shade-qty-counter").remove();
